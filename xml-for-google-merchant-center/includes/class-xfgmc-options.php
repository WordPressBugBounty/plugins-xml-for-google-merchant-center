...
/**
 * Unified options management for XML for Google Merchant Center.
 *
...
class XFGMC_Options {
	 ...
	 * XFGMC_Options::settings_update('price', 99.99, 'yes', '2', 'xfgmc');
	 * 
	 * // Update global option (bypass feed system)
	 * XFGMC_Options::settings_update('my_option', 'value');
	 *
	 * @since 0.1.0
	 *
	...
	public static function settings_update( string $option_name, $option_value, $autoload = 'no', $feed_id = '0', $slug = '' ) {
		...
		error_log( "XFGMC_Options::settings_update - Critical: Failed to update $option_name after $max_retries attempts" );
		return false;
